# Idea:
# We add alfa to make the heuristic more significant than long paths
# For ex. 3 we get 526 moves, around 29 time.
# For alfa = 1.2 we get 536 moves, around 10 time (15 cases passed)
# For alfa = 1.4 we get 556 moves, around 9.5 time (11 cases passed)
# For alfa = 2 we get 564 moves, around 0.3 time (6 tests passed)
    ...
    while pq:
        ...
        for direction in directions:
            ...
            if ns_tuple not in visited or new_cost < visited[ns_tuple]:
                ...
                heapq.heappush(pq, (new_cost + alfa * heur(new_state, dist_map),
                                    new_cost,
                                    ns_tuple,
